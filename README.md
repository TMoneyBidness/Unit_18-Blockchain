...
![Images](images/application-image.png)
...
Streamlit is an open-source python library for creating and sharing web apps for data science and machine learning projects. The library can help create and deploy a data science solution quickly. Streamlit can seamlessly integrate with other popular python libraries used in Data science such as NumPy, Pandas, Matplotlib, Scikit-learn and many more.

## Results

![Images](images/Taylor_Pychain.png)
